...
const required = ['index.html','manifest.json','sw.js','vercel.json','firebase.json','firestore.rules','favicon.svg','icon-192.png','icon-512.png','icon-maskable-512.png','apple-touch-icon.png','privacy.html','terms.html','about.html','contact.html','404.html','api/chat.js'];
...
for(const marker of ['myLifeTracker.v5','myLifeTracker.profile.v1','myLifeTracker.session.v1','myLifeTracker.pet.v1','myLifeTracker.quests.v1','myLifeTracker.focus.v1','myLifeTracker.cloud.v1','taskPriority','data-journal-mood','weeklyInsightsTitle','/manifest.json','/sw.js']) {
