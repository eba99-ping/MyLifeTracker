...
for(const marker of ['myLifeTracker.v5','myLifeTracker.profile.v1','myLifeTracker.session.v1','myLifeTracker.pet.v1','myLifeTracker.quests.v1','myLifeTracker.focus.v1','myLifeTracker.cloud.v1','/manifest.json','/sw.js']) {
